...
public:
	...
	//--------------------------------------------------------
	//
	//	this is so i can make the thing like lua
	//	i.e lua_pushuserdata and lua_touserdata
	//
	//--------------------------------------------------------
	...
	//--------------------------------------------------------
	//
	//	same thing as above but just makes userdata
	//
	//--------------------------------------------------------
	void PushUserData(const std::string& name, void* data);

	//--------------------------------------------------------
	//
	//	delete a ptr from the std::map
	//
	//--------------------------------------------------------
	void DeleteUserData(const std::string& name);

	//--------------------------------------------------------
	//
	//	returns true if the string is userdata
	//
	//--------------------------------------------------------
	bool IsUserData(const std::string& name);
